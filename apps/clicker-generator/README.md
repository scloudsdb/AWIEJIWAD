...
**Live site:** https://ai3dlabs.github.io/Clicker-Generator/
...
1. Open the [GitHub page](https://github.com/ai3dlabs/Clicker-Generator).
...
```bash
git clone https://github.com/ai3dlabs/Clicker-Generator.git
```
