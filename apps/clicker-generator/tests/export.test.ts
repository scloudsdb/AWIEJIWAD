...
const checks: [string, boolean][] = [
  ...
  ['vl:application metadata', /<metadata name="vl:application">A&I 3D Labs Clicker Generator<\/metadata>/.test(model)],
  ['Designer metadata', /<metadata name="Designer">A&I 3D Labs<\/metadata>/.test(model)],
  ['vl namespace declared', /xmlns:vl="/.test(model)],
  ['has Metadata/AI3DLabs_labs.txt', names.includes('Metadata/AI3DLabs_labs.txt')],
];
