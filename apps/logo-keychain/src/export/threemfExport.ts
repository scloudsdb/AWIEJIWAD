...
export function buildThreeMF(parts: ClickerPart[], opts: ThreeMFOptions = {}): Uint8Array {
  ...
  const metadata =
    ...
    `<metadata name="vl:application">${esc('A&I 3D Labs Clicker Generator')}</metadata>` +
    `<metadata name="CreationDate">${creationDate}</metadata>` +
    `<metadata name="Copyright">${esc('© A&I 3D Labs. Generated by the A&I 3D Labs Clicker Generator.')}</metadata>` +
  ...
  const provenance = [
    'A&I 3D Labs - Clicker Generator',
    '',
    'This 3MF was generated by the A&I 3D Labs Clicker Generator.',
    `Build: ${buildId}`,
