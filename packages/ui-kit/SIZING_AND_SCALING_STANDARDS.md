# A&I 3D Labs Sizing and Scaling Standards

As per standard design patterns established in the **Clicker Generator**, the following sizing and scaling rules apply across all A&I 3D Labs web tools to maintain a consistent 1-to-1 look and feel.
