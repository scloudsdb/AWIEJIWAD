// The standard A&I 3D Labs 3D preview, extracted from the magnet generator's
...
import { themeColorHex } from '@AI3DLabs/ui-kit';
import { createBuildPlate, type BuildPlate } from '@AI3DLabs/plates/three';
import { loadPlateChoice, type PlateChoice } from '@AI3DLabs/plates';

// `setPlate` takes this, so an app that calls it needs to be able to name it without
// taking its own dependency on @AI3DLabs/plates just for a type.
