...
//
// Run: pnpm --filter @AI3DLabs/plates build-meshes
...
const FILE_TO_ID = {
  ...
  'Anycubic Kobra 1 Max_buildplate_model.3mf': 'kobra1max',
  'Anycubic Kobra 1 Plus_buildplate_model.3mf': 'kobra1plus',
  'Anycubic Kobra 1 _buildplate_model.3mf': 'kobra1',
  'Anycubic Kobra 2 Max_buildplate_model.3mf': 'kobra2max',
  'Anycubic Kobra 2 Neo_buildplate_model.3mf': 'kobra2neo',
  'Anycubic Kobra 2 Plus_buildplate_model.3mf': 'kobra2plus',
  'Anycubic Kobra 2 Pro_buildplate_model.3mf': 'kobra2pro',
  'Anycubic Kobra 2_buildplate_model.3mf': 'kobra2',
  'Anycubic Kobra 3 Max_buildplate_model.3mf': 'kobra3max',
  'Anycubic Kobra 3 V2_buildplate_model.3mf': 'kobra3v2',
  'Anycubic Kobra 3_buildplate_model.3mf': 'kobra3',
  'Anycubic Kobra 4_buildplate_model.3mf': 'kobra4',
  'Anycubic Kobra S1 Max_buildplate_model.3mf': 's1max',
  'Anycubic Kobra S1_buildplate_model.3mf': 's1',
  'Anycubic Kobra X_buildplate_model.3mf': 'kobrax',
};
...
function normalise({ verts, tris }) {
  ...
  const zTop = hi[2];
  const edges = [];
  const onTop = (v) => Math.abs(verts[v * 3 + 2] - zTop) < 0.01;
  ...
  const body = rows.filter((r) => r[2] - r[1] >= fullWidth * 0.5);
