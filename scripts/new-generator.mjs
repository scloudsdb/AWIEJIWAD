...
edit('index.html', (s) =>
  s
    .replace('<title>Generator Template · AI3DLabs</title>', `<title>${escapeHtml(title)} · AI3DLabs</title>`)
    .replace(
      'content="Starter template for a AI3DLabs parametric generator."',
...
edit('src/main.ts', (s) =>
  s
    ...
    .replace("application: 'AI3DLabs Generator Template'", `application: 'AI3DLabs ${title}'`)
...
- \`src/style.css\` — only what is unique to this app. Anything a second generator could
  want belongs in \`@AI3DLabs/ui-kit\`.
`;
}
