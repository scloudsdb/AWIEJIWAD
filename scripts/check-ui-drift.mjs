...
/*
  ...
  `@AI3DLabs/ui-kit` has looked like a design system since it shipped, and for the chrome it
...
const BUDGET = {
  ...
  // re-derived locally. The kit pair guards on isDesktop(), reads prices from @AI3DLabs/brand and
...
if (over.length > 0) {
  failed = true;
  console.error('\nUI drift: a hand-built control was added instead of using @AI3DLabs/ui-kit.\n');
